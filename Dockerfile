...
RUN apt-get update
RUN apt-get install openssl ca-certificates nginx php7.0 php7.0-fpm php7.0-mysql -y

ADD https://getcomposer.org/composer.phar /usr/local/bin/composer && chmod a+x /usr/local/bin/composer
